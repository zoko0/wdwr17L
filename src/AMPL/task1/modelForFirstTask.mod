...
#koszty magazynowania oleju roslinnego
subject to vege_storage_costs {i in vege_oilsTypes}:
...
#koszty magazynowania oleju nieroslinnego
subject to nonvege_storage_costs {i in nonvege_oilsTypes}:
